...
public class AfiliacionAfpControlador {
    ...
    @PostMapping("/save")
	public String guardarAfiliacion(@ModelAttribute AfiliadoFondoPension afiliado,RedirectAttributes flash,Model model,
	...
	public String actualizarAfiliacion(@ModelAttribute AfiliadoFondoPension afiliado,RedirectAttributes flash,Model model,
	@RequestParam("idObrero") Long idObrero){
		afiliadoAfpService.save(afiliado);
